...
///   defining custom instruments is out of scope until `.pti` support lands.
public enum ProjectBundleWriter {
    ...
    public static func write(
        ...
        return Result(projectDirectory: projectDir, projectFile: projectFile, patternFiles: patternURLs, instrumentFiles: instrumentURLs)
    }
}
